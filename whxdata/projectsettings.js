...
rh = window.rh;
model = rh.model;
var defaultTopic = "assets/IRCTC1/Welcome_to_IRCTC.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("assets/IRCTC1/Welcome_to_IRCTC.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', 'f3fbd49c-8c0d-488c-8a0d-14b0318eb946' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "IRCTC_Online_Manual");
